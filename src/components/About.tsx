...
const About = () => {
    return (
        <div className='max-w-[1200px] mx-auto' id='about'>
            ...
            <div className='px-6 md:px-0 grid md:grid-cols-6 lg:grid-cols-8 gap-6 place-items-center'>
                ...
                <div className='w-full md:col-span-5 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-lg overflow-hidden'>
                    ...
                    <div className='flex flex-row p-6 gap-4'>
                        ...
                        <div className='flex flex-col mt-4'>
                            ...
                            <p className='text-lg text-white/70 mt-2'>I hold a degree in Computer Science and I am focusing on technologies like React, Next.js, Tailwind CSS, and TypeScript.</p>
                        </div >
                    </div>
                </div>
                ...
                <div className='w-full md:col-span-3 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-lg overflow-hidden'>
                    ...
                    <div className='flex flex-row p-6 gap-4'>
                        ...
                        <div className='flex flex-col mt-4'>
                            ...
                            <p className='text-lg text-white/70 mt-2'>I have a diverse portfolio of projects that showcase my skills in web development and problem-solving.</p>
                        </div >
                    </div>
                </div>
                ...
                <div className='w-full md:col-span-5 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-lg overflow-hidden'>
                    ...
                    <div className='flex flex-row p-6 gap-4'>
                        ...
                        <div className='flex flex-col mt-4'>
                            ...
                            <p className='text-lg text-white/70 mt-2'>As a front-end developer, I have a solid foundation in HTML, CSS, and JavaScript. I am also proficient in React, Next.js, Tailwind CSS, and TypeScript.</p>
                        </div >
                    </div>
                </div>
